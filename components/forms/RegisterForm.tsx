...
const RegisterForm = ({ user }: { user: User }) => {
    ...
    async function onSubmit(values: z.infer<typeof PatientFormValidation>) {
        ...
        if(values.identificationDocument && values.identificationDocument.length > 0) {
            ...
            formData.append('blobFile', blodFile)
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
                ...
                <div className="flex flex-col gap-6 xl:flex-row">
                    <CustomFormField
                        ...
                        name="address"
                        label="Address"
                        placeholder="Boysun 11B Yashnaobod Toshkent"
                ...
                <div className="flex flex-col gap-6 xl:flex-row">
                    ...
                    <CustomFormField
                        ...
                        placeholder="Ibuprophen 400mg, Paracetamol 500mg"
                ...
                <div className="flex flex-col gap-6 xl:flex-row">
                    <CustomFormField
                        ...
                        placeholder="Mother had brain cancer, Father had heart disaese"
                ...
                <section className="space-y-6">
                    ...
                    <h2 className="sub-header">
                        Identifcation and Verification
                    </h2>
                </section>
